...
<body>
	...
	if (deleteMessage != null) {
		...
		response.setHeader("Refresh", "1;url=view");
	} else {
		delmsg = "";
	}
	...
	<div align="center">
	<h3 style="text-align:center; text-decoration:underline">MEMBER INVENTORY</h3>
	...
	<a href="addMemberRecord" style="float:left"> Add New Record</a><br/>
	<table id="example"
		...
		<tbody>
			<c:forEach var="data" items="${listData}">
					<tr>
						...
						<td>
						 	<a href="editMemberRecord?id=${data.itemId}">Edit</a>
						 	<a href="deleteMemberRecord?id=${data.itemId}">Delete</a>
						</td>
					</tr>
				</c:forEach>
		</tbody>
